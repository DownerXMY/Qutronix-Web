<template>
  <el-form ref="form" :model="user_form" label-width="80px">
    <el-form-item label="用户昵称">
      <el-input v-model="user_form.user_pet_name" placeholder="请输入用户昵称"  style="width: 300px"></el-input>
    </el-form-item>
    <el-form-item label="用户名">
      <el-input v-model="user_form.user_name" placeholder="请输入用户名"  style="width: 220px"></el-input>
    </el-form-item>
    ...
    <div align="center">
      ...
      <el-button type="success" size="small" @click="add('add')" v-show="password_input_state">确认新增</el-button>
    </div>
  </el-form>
</template>
