    ...
    <div id="app" class="joint-app joint-theme-modern">
      <div class="app-header">
        ...
        <div class="toolbar-container">
          ...
          <label for="ox" title="Position of zero x-coordinate of the paper in pixels"
            style="font-size: 15px;margin-left: 10px">整体左右移动</label>
          <input id="ox" name="ox" type="range" value="0" min="-200" max="200" autocomplete="off" />
          <label for="oy" title="Position of zero y-coordinate of the paper in pixels"
